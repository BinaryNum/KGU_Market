      ...
      <div id="main" class="col-md-9">
		...
		<input  type="hidden" name="bName" value="${userid}">
			...
			<tr>
				...
				<td> 가격 </td>
				<td> <input placeholder="숫자만 입력 가능합니다."  class="form-control" type="text" name="price" size = "50"> </td>
			</tr>
			<tr>
				<td> 내용 </td>
			...
			<tr>
				<td> 이미지 </td>
				<td><input class="form-control"   type="file" name="file" >※ 영문파일만 입력 가능합니다. </td>
				
			</tr>
			
			<tr >
				<td colspan="2"> <input type="submit"  class="btn" value="입력"> &nbsp;&nbsp; <a href="list.do?i=0">목록보기</a></td>
			</tr>
		</form>
	</table>
